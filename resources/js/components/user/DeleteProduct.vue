        ...
        <div class="w-full max-w-lg p-3 relative mx-auto my-auto rounded-xl shadow-lg  bg-white">
            ...
            <div class="">
                ...
                <div class="text-center p-3 flex-auto justify-center">
                    ...
                    <h3 class="text-xl font-bold py-4 ">Are you sure to delete this Product?</h3>
...
export default {
    ...
    methods: {
        deleteProduct() {
            axios.post('dashboard/delete/product',{id: this.id, current_page: this.current_page})
                .then(response => {
                    this.$emit('deleteProduct', response.data.product);
                })
