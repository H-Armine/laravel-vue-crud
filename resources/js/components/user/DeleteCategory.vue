        ...
        <div class="w-full  max-w-lg p-3 relative mx-auto my-auto rounded-xl shadow-lg  bg-white ">
            ...
            <div class="">
                ...
                <div class="text-center p-3 flex-auto justify-center">
                    ...
                    <h3 class="text-xl font-bold py-4 ">Are you sure to delete this Category?</h3>
                    <p class="text-lg text-gray-700">
                        Make sure that no one product has been created with this category,
                        because this process cannot be undone.</p>
                </div>
                <!--footer-->
...
export default {
    ...
    methods: {
        deleteCategory() {
            ...
            axios.post('dashboard/delete/category', data)
                .then(response => {
                    this.$emit('deleteCategory', response.data.category);
                })
